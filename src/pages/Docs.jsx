    ...
    <div className="space-y-6">
      <div className="flex items-center">
        ...
        <div>
          ...
          <p className="text-gray-600">Diagramas y documentos técnicos del proyecto</p>
        </div>
      </div>
      ...
      <Card className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {diagramas.map((diagrama) => (
            <div key={diagrama.id} className="border rounded-lg p-4 hover:shadow-md transition-shadow">
              ...
              <div>
                <div className="flex justify-between items-start mb-2">
                  <h3 className="font-semibold text-gray-900">{diagrama.nombre}</h3>
                  <span className="text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded">
                    {diagrama.categoria}
                  </span>
                </div>
                <p className="text-sm text-gray-600 mb-3">{diagrama.descripcion}</p>
                <button
          ...
          <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-auto">
            <div className="p-6 border-b">
              <div className="flex justify-between items-center">
                <h2 className="text-xl font-semibold">{selectedDiagram.nombre}</h2>
                <button
            ...
            <div className="p-6">
              <div className="aspect-video bg-gray-100 rounded-lg flex items-center justify-center">
                <div className="text-center p-8">
                  ...
                  <p className="text-2xl font-medium text-gray-700 mb-2">Placeholder</p>
                  <p className="text-gray-500">{selectedDiagram.nombre}</p>
                  <p className="text-sm text-gray-400 mt-4">
                    Reemplazar con imagen real: /docs/diagrams/{selectedDiagram.archivo}
                  </p>
                </div>
              </div>
            </div>
